...
_Float128 f(_Float128 t) {
    return t;
}

_Float128 g(_Float128 t) {
    return exp(t);
}

struct answer * euler_method(struct answer *a, _Float128 dt, _Float128 max){
    _Float128 t = 0.0;
    _Float128 x = 1.0;
    _Float128 d_x = 0.0;
    _Float128 exat = 0.0;
...
struct answer * runge_kutta_method_02(struct answer *a, _Float128 dt, _Float128 max){
    _Float128 x = 1.0;
    _Float128 d_x = 0.0;
    _Float128 t = 0.0;
    _Float128 k_1 = 0.0;
...
struct answer * runge_kutta_method_04(struct answer *a, _Float128 dt, _Float128 max){
    _Float128 x = 1.0;
    _Float128 d_x = 0.0;
    _Float128 t = 0.0;
    _Float128 k_1 = 0.0;
 ...
 * gcc prog05_02_03_005.c -lm -lquadmath
 * */
bool main(void) {
    FILE *tmp_file;
    _Float128 x = 1.0;
    ...
    int max = 0;
    int values = 7;
    const char *path = "data/prog05_02_03_001_Float128.csv";
    _Float128 list_dt[7] = {0.1, 0.01, 0.001, 0.0001, 0.00001, 0.000001, 0.0000001};
    //_Float128 list_dt[5] = {0.2, 0.1, 0.05, 0.025, 0.0125};
    int list_max[7] = {100, 1000, 10000, 100000, 1000000, 10000000, 100000000};
    //int list_max[5] = {50, 100, 200, 400, 800};
    _Float128 list_time[1] = {10.0};
    ...
    for (unsigned int i = 0; i < values; i++) {
        ...
        //for (unsigned int j = 0; j < 1; j++) { 
            ...
            //quadmath_snprintf(a_time,80,"%.40Qf",a->time);
            //
            ...
            //quadmath_snprintf(b_time,80,"%.40Qf",b->time);
            //
            ...
            //quadmath_snprintf(c_time,80,"%.40Qf",c->time);
