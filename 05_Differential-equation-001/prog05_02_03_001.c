...
bool main(void) {
    ...
    int max = 0;
    int values = 7;
    const char *path = "data/prog05_02_03_001.csv";
    double list_dt[7] = {0.1, 0.01, 0.001, 0.0001, 0.00001, 0.000001, 0.0000001};
